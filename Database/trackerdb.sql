...
CREATE TABLE `trackinglog` (
  ...
  `StatusBitTank1` varchar(1) DEFAULT NULL,
  `QtyLtTank1` float DEFAULT NULL,
  `StatusBitTank2` varchar(1) DEFAULT NULL,
  `QtyLtTank2` float DEFAULT NULL,
  PRIMARY KEY (`idLog`)
...
-- Dump completed on 2014-02-02  0:36:27
